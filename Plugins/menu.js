...
let tags = {
  '.ملصق':'  ‎| • صنع ملصق
 '.حقوق'  | • تغير حقوق الملصق
  '.وينك.`  | • تيست للبوت
   '.تاق.'  | • تاق للجميع
    '.المطور  | • متابعة احدث التطورات
     '.صور  | • تحميب صور من جوجل
}
const defaultMenu = {
  before: `السلام عليكم 👋. 
...
externalAdReply: {
title: 'TETO-BOT-MD'
body: "أول بوت سوداني 🇸🇩❤️",
thumbnailUrl: 'https://telegra.ph/file/8a56b7b33a6c8bec50f9c.jpg',
sourceUrl: 'https://instagram.com/awabofficial',
mediaType: 1,
...
handler.command = ['menu','أوامر','list'] 
